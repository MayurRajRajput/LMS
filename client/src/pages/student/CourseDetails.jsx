...
const CourseDetails = () => {
  ...
  const {allCourses,currency,calculateRating,calculateNoOfLectures,calculateCourseDuration,calculateChapterTime,backendUrl,userData,getToken} =  useContext(AppContext)
